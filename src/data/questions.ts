...
const answerAliases: Record<string, string[]> = {
  ...
  福岡県: ['福岡', 'ふくおか', 'fukuoka'],
  那覇市: ['那覇', 'なは', 'naha'],
  'ワシントンD.C.': ['ワシントン', 'washington dc', 'washington d.c.', 'washington'],
  北京: ['ぺきん', 'beijing', 'pekin'],
  ソウル: ['seoul'],
  キャンベラ: ['canberra'],
  ブラジリア: ['brasilia'],
  ナイル川: ['ないるがわ', 'nile', 'nile river'],
  スイス: ['switzerland', 'suisse', 'swiss'],
  ロシア: ['russia'],
  アフリカ大陸: ['アフリカ', 'africa'],
...
const questionBanks: QuestionBank[] = [
  ...
  },
  {
    ...
    seeds: [
      ...
      { prompt: 'アルプス山脈と観光・酪農で知られるヨーロッパの国は？', answer: 'スイス' },
      { prompt: '世界で最も面積が大きい国は？', answer: 'ロシア' },
      { prompt: '赤道がほぼ中央を通る大陸は？', answer: 'アフリカ大陸', acceptableAnswers: ['アフリカ大陸', 'アフリカ'] },
  ...
  },
  {
    ...
    seeds: [
      ...
      { prompt: '都市中心部の人口が減り、周辺部に人口が移る現象は？', answer: 'ドーナツ化現象' },
  ...
  },
  {
    ...
    level: 'eiken4',
    seeds: [
      { prompt: '「早い時間に」は英語で？', answer: 'early' },
      { prompt: '「遅れて・遅い時間に」は英語で？', answer: 'late' },
